...
(async () => {
  console.log('=== Playwright Google Search Demo ===');
  ...
  try {
    ...
    console.log('Step 2: Navigating to Google.com...');
    ...
    console.log('Step 3: Taking screenshot of Google homepage...');
    await page.screenshot({ path: '/home/captain/projects/test_caude_code/google_homepage.png' });
    
    console.log('✓ Screenshot saved: google_homepage.png');
    ...
    await page.screenshot({ path: '/home/captain/projects/test_caude_code/search_input_filled.png' });
    ...
    console.log('\n=== SCREENSHOTS TAKEN ===');
    console.log('1. /home/captain/projects/test_caude_code/google_homepage.png');
    console.log('2. /home/captain/projects/test_caude_code/search_input_filled.png');
    console.log('3. /home/captain/projects/test_caude_code/search_results.png');
    ...
    console.log('4. Check if Google is accessible from your network');
  }
})();